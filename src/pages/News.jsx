...
/* 
  Mảng newLists:
  - Chứa dữ liệu các bài viết
  - Mỗi object đại diện cho 1 card tin tức
  - id dùng làm key cho React
  - title: tiêu đề bài
  - description: mô tả ngắn
  - images: đường dẫn ảnh
  - link: đường dẫn chi tiết
*/
const newLists = [
  ...
  return (
    <div className="news">
      ...
      <div className="news-grid">
        ...
        {/* 
          Dùng map() để lặp qua mảng newLists
          Với mỗi phần tử → render 1 card tin tức
        */}
        {newLists.map((news) => (
